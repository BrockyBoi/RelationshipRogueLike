...
namespace Maze.Generation
{
    public class MazeGenerator : MonoBehaviour
    {
        ...
        public bool ShouldShake { get { return _shouldShake; } }
        [SerializeField, Range(0, 1)]
        private float _shakeIntensity = .5f;
        public Vector2 OffsetPos { get; private set; }

        [SerializeField]
        private bool _shouldRotate = false;
        [SerializeField]
        private float _rotationRate = .15f;

        public bool ShouldRotate { get { return _shouldRotate; } }
        public float RotationRate { get { return _rotationRate; } }
        ...
        private void Update()
        {
            ...
            {
                DestroyMaze();
                StartCoroutine(BuildMazeOverTime());
            }

            OffsetPos = _shouldShake ? Random.insideUnitCircle * _shakeIntensity : Vector2.zero;
        }
        ...
        {
            _maze = new MazeNode[_mazeSize.x, _mazeSize.y];
        ...
        private void BuildInstantMaze()
        {
            ...
            bool hasReachedStartNode = false;
