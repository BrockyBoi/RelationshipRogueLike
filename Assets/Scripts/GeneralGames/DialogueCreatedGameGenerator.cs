...
{
    public abstract class DialogueCreatedGameGenerator<GenerationData, CompletionResult> : BaseGameGenerator where GenerationData : GameGenerationData where CompletionResult : GameCompletionResult
    {
